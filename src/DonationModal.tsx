...
const donation: React.FC = () => {
  ...
  return (
    <>
      ...
      <Modal title="Add Donation" className="btn" open={isModalOpen} onOk={handleOk} onCancel={handleCancel} okButtonProps={{ className: "custom-ok-button" }} cancelButtonProps={{ className: "custom-cancel-button" }} okText="Save" cancelText="Cancel">
        ...
        <Space direction="vertical">
          ...
          <div className="notes">
            ...
            <div className="n-input">
              <TextArea rows={5} size="small" className="notes-field" autoSize={false} style={{ resize: "none" }} />
            </div>
          </div>
        </Space>
      </Modal>
